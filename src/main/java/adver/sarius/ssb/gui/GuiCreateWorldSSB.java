...
// Cant extend GuiCreateWorld because super() calls and private variables. Cant copy because WorldType needs GuiCreateWorld....
// TODO: Unused, so far...

@SideOnly(Side.CLIENT)
public class GuiCreateWorldSSB extends GuiScreen
{
    ...
    public GuiCreateWorldSSB(GuiScreen p_i46320_1_)
    {
//    	super(p_i46320_1_);
        this.parentScreen = this.parentScreen == null ? p_i46320_1_ : this.parentScreen;
        this.worldSeed = "";
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.enabled)
        {
            ...
            {
            	if(WorldType.WORLD_TYPES[this.selectedIndex] == SimpleSkyBlockMod.WORLD_TYPE_SSB
