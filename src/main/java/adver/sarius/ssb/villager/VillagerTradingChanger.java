...
public class VillagerTradingChanger {
	...
	public static VillagerProfession prof;
	// TODO: Use fixed/configured villager ID to make sure server and client use the same?
	public static void registerVillager(){
		prof = new VillagerProfession(SimpleSkyBlockMod.MODID + ":nitwit",
